...
if __name__ == "__main__":
    ...
    parser.add_argument("--tolerance", type=int, default=5, help="tolerance margin for evaluation")
    parser.add_argument("--random_crop_size", type=int, default=256, help="tolerance margin for evaluation")    
...
#            normalize
    ...
    val_loader = torch.utils.data.DataLoader(
        val_dset, batch_size=4, shuffle=True)
